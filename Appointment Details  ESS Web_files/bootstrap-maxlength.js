    ...
    maxlength: function (options, callback) {
      ...
      */
      ...
      function getPosition(currentInput) {
          ...
          var someArray = { width: el.offsetWidth, height: el.offsetHeight };
          if ((typeof el.getBoundingClientRect === 'function')) {
              try {
                  // Wrapping this inside try/catch because of 'unspecified error' message http://bugs.jquery.com/ticket/4996.
                  someArray = el.getBoundingClientRect();
              } catch (error) {
                  someArray = { width: el.offsetWidth, height: el.offsetHeight };
              }
          }
        return $.extend({}, someArray, currentInput.offset());
      }
